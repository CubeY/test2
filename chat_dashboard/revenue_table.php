<div style="margin-top:20px;width:1335px;" class="list_user">
    <div style="display:table;width:100%;bor der:1px solid #ccc;margin-bottom:10px;" class="table_view">
         <div class="ov_head">Revenue table&nbsp; </div>
        </div>
       ...
       // print_r($rtmrow);
        ...
        <div class="revenue_data_2" style=""><div align="center" style="padding:20px 0;"><img src="media/images/iconWorking.gif"  /></div></div>
...
$(document).ready(function(e) {
   var todo = 'get_revenue_table';
	$.ajax({  
	type: "POST", 
	url: 'ajax/ajax_revenue.php', 
	data: "todo="+todo+"&thumb=1&w=22&h=",
	dataType: "html",
	success: function(data){
		$('.revenue_data_2').html(data);
